...
def train(device_ids):
    ...
    '''
    #Obtain point project features for train and test sets
    _, _, _, dataset.input_data = point_projection_feature(dataset.input_data)
    _, _, _, dataset.gt_data = point_projection_feature(dataset.input_data)
    print('Get point projection feature of train set:')
    print(dataset.input_data.shape)
    print(dataset.gt_data.shape)
    print(dataset.labels.shape)
    _, _, _, dataset_test.input_data = point_projection_feature(dataset_test.input_data)
    _, _, _, dataset_test.gt_data = point_projection_feature(dataset_test.input_data)
    print('Get point projection feature of test set:')
    print(dataset_test.input_data.shape)
    print(dataset_test.gt_data.shape)
    print(dataset_test.labels.shape)
    #####
