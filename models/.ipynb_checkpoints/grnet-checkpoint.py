...
class Model(torch.nn.Module):
    ...
    def forward(self, partial_cloud, gt, is_training=True, mean_feature=None, alpha=None):
        ...
        a1, a2, a3, partial_cloud = point_ortho_feature(x.transpose(1, 2).contiguous())
        ...
        sparse_cloud = inverse_point_ortho_feature(a1, a2, a3, sparse_cloud)
        dense_cloud = inverse_point_ortho_feature(a1, a2, a3, dense_cloud)
        ...
        if is_training:
            ...
            return {'out1': dense_cloud, 'out2': dense_cloud, 'cd_p': cd_p, 'cd_t': cd_t, 'f1': f1}